...
/**
 * @package     Joomla.Site
 * @subpackage  mod_articles_news_load_more
 *
...
abstract class ModArticlesNewsLoadMoreMasonryHelper
{
	...
	public static function getList(&$params,$countedItems)
	{
		...
		$model->setState('list.limit', (int) $countedItems);
		...
		foreach ($items as &$item)
		{
			...
			if ($access || in_array($item->access, $authorised))
			{
				...
				$item->link     = JRoute::_(ContentHelperRoute::getArticleRoute($item->catid, $item->language));
