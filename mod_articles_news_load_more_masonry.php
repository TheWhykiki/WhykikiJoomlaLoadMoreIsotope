...
$less->setVariables(array(
	...
	"border_style_posts" => $params->get('border_style_posts'),
	"border_style_loadmore" => $params->get('border_style_loadmore'),
	"border_style_filter" => $params->get('border_style_filter'),
	"color_button" => $params->get('color_button'),
	"font_hover_color_filter" => $params->get('font_hover_color_filter'),
	"font_hover_color_button" => $params->get('font_hover_color_button'),
